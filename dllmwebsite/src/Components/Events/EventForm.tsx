...
interface EventFormProps {
  ...
  submitLabel?: string;
  onCancel: () => void;
  onSubmit: (values: EventFormValues & { time?: string }) => Promise<void>;
}
...
const EventForm: React.FC<EventFormProps> = ({
  ...
  const [errors, setErrors] = useState<{ timeEnd?: string }>({});
  ...
  const handleFileChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    setValues((v) => ({
      ...v,
      thumbnail: file ? URL.createObjectURL(file) : v.thumbnail,
    }));
  };
